...
driver = GraphDatabase.driver("bolt://35.171.16.234:7687", auth=("neo4j", "foreground-highway-coat"))  
# Verify Connectivity
...
def get_actors(tx, movie):
    ...
    # Accédez à la propriété 'actor_name' au lieu de 'p'
...
with driver.session() as session:
    # Utilisez execute_read pour exécuter la transaction de lecture
